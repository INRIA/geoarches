...
class MetricBase:
    def __init__(
        ...
        # self.indices = {}
        # if self.lead_time_hours and self.variable_indices is not None and rollout_iterations > 1:
        ...
        #             self.indices[f"{var}_{lead_time}h"] = (i, *index)
        # else:
        #     self.indices = self.variable_indices
